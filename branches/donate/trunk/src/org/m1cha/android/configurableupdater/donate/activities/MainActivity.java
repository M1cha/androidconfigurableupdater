...
public class MainActivity extends TabActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=0; i<tabHost.getTabWidget().getChildCount(); i++) {
        	...
        	/** The MIUI-Tabs are 59 in height. They are already looging good so don't change their height */
        	if(tabHost.getTabWidget().getChildAt(i).getLayoutParams().height!=59) {
